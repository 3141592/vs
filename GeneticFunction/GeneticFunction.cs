...
{
    public partial class GeneticFunction : Form
    {
        private GraphSettings grSettings = new GraphSettings();
        private Calulations calculations;
        private GraphSettingsDialog mGraphSettingsDialog;
        private GeneticSettingsDialog mGeneticSettingsDialog;
        private List<Color> ColorList;
        private Color OppositeGraphColor;
        private PointPairList mFunctionValues = new PointPairList();
        private string mGeneticEquation;
        ...
        {
            if (mGraphSettingsDialog == null)
            {
                mGraphSettingsDialog = new GraphSettingsDialog(grSettings, this);
                mGraphSettingsDialog.Show();
            }
            else if (mGraphSettingsDialog.Exists)
            {
                mGraphSettingsDialog.Focus();
            }
            else
            {
                mGraphSettingsDialog = new GraphSettingsDialog(grSettings, this);
        ...
        private void calculationsToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                calculations = new Calulations(this, FunctionValues);
                calculations.Show();
            }
        ...
        public string GeneticEquation
        {
            get { return mGeneticEquation; }
            set { mGeneticEquation = value; }
        }
